    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Eidt Sub Insurance Company Details
                    <!--begin::Separator-->
                ...
                <div>
                    ...
                    <div class="card-body">
                        <div class="employee_from_div">
                            <form method="POST" action="{{url('submit_edit_subinsurance_company')}}" enctype="multipart/form-data" class="addForm">
                                @csrf

                                <input type="hidden" name="inscompanyId" value="{{$inscompany->id}}">
                                    <div class="row">
                                        <div class="mb-3 col-lg-6">
                                        <label>Select Parent Company:</label><br>
                                        <select name="mainCompany" id="mainCompany">
                                        @foreach ($maincompanies as $maincompany)
                                        <option value="{{$maincompany->id}}" @php
                                            if($maincompany->id==$inscompany->main_company_id){ echo "selected";}
                                        @endphp>{{$maincompany->name}}</option> 
                                        @endforeach      
                                        </select> 
                                        @error('mainCompany')
