...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center justify-content-between w-100 me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Expoence Categories
    ...
    <div class="modal fade" id="MakeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{url('submit_category')}}" enctype="multipart/form-data" class="addForm">
                @csrf
            <div class="modal-content col-lg-12" >
                ...
                <div class="modal-body col-lg-12">
                    ...
                    <div class="mb-3 col-lg-12">
                        ...
                        <input type="text" class="form-control" name="catname" required placeholder="Enter Category Name" data-type="add">
                        @error('makname')
    ...
    <section class="card">
        <div class="d-flex align-items-center gap-10 my-10 flex-wrap">
            ...
            <button  class="btn btn-primary make-button">Add Category</button>
        </div>
        <div class="table-responsive">
            <table class="table text-center">
                ...
                <tbody>
                    @foreach ($expensecategories as $expencecaegory)
                    <tr>
                        <td>{{$expencecaegory->id}}</td>
                        <td>{{$expencecaegory->name}}</td>
                        <td>
                            <a href="{{url('edit_cat/'.$expencecaegory->id)}}" class="text-primary action-button">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#"  class="text-danger action-button delete-button" data-id="{{$expencecaegory->id}}">
