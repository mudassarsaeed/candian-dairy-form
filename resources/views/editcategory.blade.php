...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <section class="card">
        ...
        <div class="table-responsive">
             <form method="POST" action="{{url('submit_editcategory')}}" enctype="multipart/form-data" class="addForm">
                @csrf
        ...
        <div class="row">    
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="catname" required  value="{{$cat->name}}" data-type="add">
                    @error('makname')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center justify-left-left">
